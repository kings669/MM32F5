...
#define SD_CLOCK_25MHZ     (25000000u)  /*!< SD card bus frequency 1 in high-speed mode */
#define SD_CLOCK_50MHZ     (50000000u)  /*!< SD card bus frequency 2 in high-speed mode */
#define SD_CLOCK_100MHZ    (100000000u) /*!< SD card bus frequency in SDR50 mode */
#define SD_CLOCK_208MHZ    (208000000u) /*!< SD card bus frequency in SDR104 mode */
#define MMC_CLOCK_26MHZ    (26000000u)  /*!< MMC card bus frequency 1 in high-speed mode */
#define MMC_CLOCK_52MHZ    (52000000u)  /*!< MMC card bus frequency 2 in high-speed mode */
#define MMC_CLOCK_DDR52    (52000000u)  /*!< MMC card bus frequency  in high-speed DDR52 mode */
#define MMC_CLOCK_HS200    (200000000u) /*!< MMC card bus frequency  in high-speed HS200 mode */
#define MMC_CLOCK_HS400    (400000000u) /*!< MMC card bus frequency  in high-speed HS400 mode */
...
#define SDMMC_R1_ALL_ERROR_FLAG                                                                      \
    (SDMMC_MASK(SDMMC_R1OutOfRangeFlag) | SDMMC_MASK(SDMMC_R1AddressErrorFlag) |                   \
     SDMMC_MASK(SDMMC_R1BlockLengthErrorFlag) | SDMMC_MASK(SDMMC_R1EraseSequenceErrorFlag) |       \
     SDMMC_MASK(SDMMC_R1EraseParameterErrorFlag) | SDMMC_MASK(SDMMC_R1WriteProtectViolationFlag) | \
     SDMMC_MASK(SDMMC_R1CardIsLockedFlag) | SDMMC_MASK(SDMMC_R1LockUnlockFailedFlag) |             \
     SDMMC_MASK(SDMMC_R1CommandCrcErrorFlag) | SDMMC_MASK(SDMMC_R1IllegalCommandFlag) |            \
     SDMMC_MASK(SDMMC_R1CardEccFailedFlag) | SDMMC_MASK(SDMMC_R1CardControllerErrorFlag) |         \
     SDMMC_MASK(SDMMC_R1ErrorFlag) | SDMMC_MASK(SDMMC_R1CidCsdOverwriteFlag) |                     \
     SDMMC_MASK(SDMMC_R1AuthenticationSequenceErrorFlag))
...
{
    SDSPI_CmdCrc = 59U, /*!< Command crc protection on/off */
} sdspi_command_t;
...
{
    SDMMC_CommandClassBasic               = (1U << 0U),  /*!< Card command class 0 */
    SDMMC_CommandClassBlockRead           = (1U << 2U),  /*!< Card command class 2 */
    SDMMC_CommandClassBlockWrite          = (1U << 4U),  /*!< Card command class 4 */
    SDMMC_CommandClassErase               = (1U << 5U),  /*!< Card command class 5 */
    SDMMC_CommandClassWriteProtect        = (1U << 6U),  /*!< Card command class 6 */
    SDMMC_CommandClassLockCard            = (1U << 7U),  /*!< Card command class 7 */
    SDMMC_CommandClassApplicationSpecific = (1U << 8U),  /*!< Card command class 8 */
    SDMMC_CommandClassInputOutputMode     = (1U << 9U),  /*!< Card command class 9 */
    SDMMC_CommandClassSwitch              = (1U << 10U), /*!< Card command class 10 */
};

/*! @brief OCR register in SD card */
enum _sd_ocr_flag
{
    SD_OcrPowerUpBusyFlag         = 31,                             /*!< Power up busy status */
    SD_OcrHostCapacitySupportFlag = 30,                             /*!< Card capacity status */
    SD_OcrCardCapacitySupportFlag = SD_OcrHostCapacitySupportFlag, /*!< Card capacity status */
    SD_OcrSwitch18RequestFlag     = 24,                             /*!< Switch to 1.8V request */
    SD_OcrSwitch18AcceptFlag      = SD_OcrSwitch18RequestFlag,     /*!< Switch to 1.8V accepted */
    SD_OcrVdd27_28Flag            = 15,                             /*!< VDD 2.7-2.8 */
    SD_OcrVdd28_29Flag            = 16,                             /*!< VDD 2.8-2.9 */
    SD_OcrVdd29_30Flag            = 17,                             /*!< VDD 2.9-3.0 */
    SD_OcrVdd30_31Flag            = 18,                             /*!< VDD 2.9-3.0 */
    SD_OcrVdd31_32Flag            = 19,                             /*!< VDD 3.0-3.1 */
    SD_OcrVdd32_33Flag            = 20,                             /*!< VDD 3.1-3.2 */
    SD_OcrVdd33_34Flag            = 21,                             /*!< VDD 3.2-3.3 */
    SD_OcrVdd34_35Flag            = 22,                             /*!< VDD 3.3-3.4 */
    SD_OcrVdd35_36Flag            = 23,                             /*!< VDD 3.4-3.5 */
};
...
{
    SD_DataBusWidth1Bit = 0U, /*!< SD data bus width 1-bit mode */
    SD_DataBusWidth4Bit = 1U, /*!< SD data bus width 4-bit mode */
} sd_data_bus_width_t;

/*! @brief SD card switch mode */
typedef enum _sd_switch_mode
{
    SD_SwitchCheck = 0U, /*!< SD switch mode 0: check function */
    SD_SwitchSet   = 1U, /*!< SD switch mode 1: set function */
} sd_switch_mode_t;
...
{
    SD_FunctionSDR12Deafult   = 0U, /*!< SDR12 mode & default*/
    SD_FunctionSDR25HighSpeed = 1U, /*!< SDR25 & high speed*/
    SD_FunctionSDR50          = 2U, /*!< SDR50 mode*/
    SD_FunctionSDR104         = 3U, /*!< SDR104 mode*/
    SD_FunctionDDR50          = 4U, /*!< DDR50 mode*/
};

/*! @brief SD group number */
enum _sd_group_num
{
    SD_GroupTimingMode     = 0U, /*!< acess mode group*/
    SD_GroupCommandSystem  = 1U, /*!< command system group*/
    SD_GroupDriverStrength = 2U, /*!< driver strength group*/
    SD_GroupCurrentLimit   = 3U, /*!< current limit group*/
};

/*! @brief SD card timing mode flags */
typedef enum _sd_timing_mode
{
    SD_TimingSDR12DefaultMode   = 0U, /*!< Identification mode & SDR12 */
    SD_TimingSDR25HighSpeedMode = 1U, /*!< High speed mode & SDR25 */
    SD_TimingSDR50Mode          = 2U, /*!< SDR50 mode*/
    SD_TimingSDR104Mode         = 3U, /*!< SDR104 mode */
    SD_TimingDDR50Mode          = 4U, /*!< DDR50 mode */
} sd_timing_mode_t;

/*! @brief SD card driver strength */
typedef enum _sd_driver_strength
{
    SD_DriverStrengthTypeB = 0U, /*!< default driver strength*/
    SD_DriverStrengthTypeA = 1U, /*!< driver strength TYPE A */
    SD_DriverStrengthTypeC = 2U, /*!< driver strength TYPE C */
    SD_DriverStrengthTypeD = 3U, /*!< driver strength TYPE D */
} sd_driver_strength_t;

/*! @brief SD card current limit */
typedef enum _sd_max_current
{
    SD_CurrentLimit200MA = 0U, /*!< default current limit */
    SD_CurrentLimit400MA = 1U, /*!< current limit to 400MA */
    SD_CurrentLimit600MA = 2U, /*!< current limit to 600MA */
    SD_CurrentLimit800MA = 3U, /*!< current limit to 800MA */
} sd_max_current_t;
...
enum _sdio_cccr_reg
{
    SDIO_RegCCCRSdioVer        = 0x00U, /*!< CCCR & SDIO version*/
    SDIO_RegSDVersion          = 0x01U, /*!< SD version */
    SDIO_RegIOEnable           = 0x02U, /*!< io enable register */
    SDIO_RegIOReady            = 0x03U, /*!< io ready register */
    SDIO_RegIOIntEnable        = 0x04U, /*!< io interrupt enable register */
    SDIO_RegIOIntPending       = 0x05U, /*!< io interrupt pending register */
    SDIO_RegIOAbort            = 0x06U, /*!< io abort register */
    SDIO_RegBusInterface       = 0x07U, /*!< bus interface register */
    SDIO_RegCardCapability     = 0x08U, /*!< card capability register */
    SDIO_RegCommonCISPointer   = 0x09U, /*!< common CIS pointer register */
    SDIO_RegBusSuspend         = 0x0C,  /*!< bus suspend register */
    SDIO_RegFunctionSelect     = 0x0DU, /*!< function select register */
    SDIO_RegExecutionFlag      = 0x0EU, /*!< execution flag register */
    SDIO_RegReadyFlag          = 0x0FU, /*!< ready flag register */
    SDIO_RegFN0BlockSizeLow    = 0x10U, /*!< FN0 block size register */
    SDIO_RegFN0BlockSizeHigh   = 0x11U, /*!< FN0 block size register */
    SDIO_RegPowerControl       = 0x12U, /*!< power control register */
    SDIO_RegBusSpeed           = 0x13U, /*!< bus speed register */
    SDIO_RegUHSITimingSupport  = 0x14U, /*!< UHS-I timing support register */
    SDIO_RegDriverStrength     = 0x15U, /*!< Driver strength register */
    SDIO_RegInterruptExtension = 0x16U, /*!< Interrupt extension register */
};

/*! @brief sdio card individual commands */
typedef enum _sdio_command
{
    SDIO_SendRelativeAddress    = 3U,  /*!< send relative address */
    SDIO_SendOperationCondition = 5U,  /*!< send operation condition */
    SDIO_SendInterfaceCondition = 8U,  /*!< send interface condition */
    SDIO_RWIODirect             = 52U, /*!< read/write IO direct command */
    SDIO_RWIOExtended           = 53U, /*!< read/write IO extended command */
} sdio_command_t;

/*! @brief sdio card individual commands */
typedef enum _sdio_func_num
{
    SDIO_FunctionNum0,   /*!< sdio function0*/
    SDIO_FunctionNum1,   /*!< sdio function1*/
    SDIO_FunctionNum2,   /*!< sdio function2*/
    SDIO_FunctionNum3,   /*!< sdio function3*/
    SDIO_FunctionNum4,   /*!< sdio function4*/
    SDIO_FunctionNum5,   /*!< sdio function5*/
    SDIO_FunctionNum6,   /*!< sdio function6*/
    SDIO_FunctionNum7,   /*!< sdio function7*/
    SDIO_FunctionMemory, /*!< for combo card*/
} sdio_func_num_t;
...
{
    SDIO_StatusCmdCRCError      = 0x8000U, /*!< the CRC check of the previous cmd fail*/
    SDIO_StatusIllegalCmd       = 0x4000U, /*!< cmd illegal for the card state */
    SDIO_StatusR6Error          = 0x2000U, /*!< special for R6 error status */
    SDIO_StatusError            = 0x0800U, /*!< A general or an unknown error occurred */
    SDIO_StatusFunctionNumError = 0x0200U, /*!< invail function error */
    SDIO_StatusOutofRange       = 0x0100U, /*!<  cmd argument was out of the allowed range*/
};

/*! @brief sdio operation condition flag */
enum _sdio_ocr_flag
{
    SDIO_OcrPowerUpBusyFlag = 31, /*!< Power up busy status */
    SDIO_OcrIONumber        = 28, /*!< number of IO function */
    SDIO_OcrMemPresent      = 27, /*!< memory present flag */

    SDIO_OcrVdd20_21Flag = 8,  /*!< VDD 2.0-2.1 */
    SDIO_OcrVdd21_22Flag = 9,  /*!< VDD 2.1-2.2 */
    SDIO_OcrVdd22_23Flag = 10, /*!< VDD 2.2-2.3 */
    SDIO_OcrVdd23_24Flag = 11, /*!< VDD 2.3-2.4 */
    SDIO_OcrVdd24_25Flag = 12, /*!< VDD 2.4-2.5 */
    SDIO_OcrVdd25_26Flag = 13, /*!< VDD 2.5-2.6 */
    SDIO_OcrVdd26_27Flag = 14, /*!< VDD 2.6-2.7 */
    SDIO_OcrVdd27_28Flag = 15, /*!< VDD 2.7-2.8 */
    SDIO_OcrVdd28_29Flag = 16, /*!< VDD 2.8-2.9 */
    SDIO_OcrVdd29_30Flag = 17, /*!< VDD 2.9-3.0 */
    SDIO_OcrVdd30_31Flag = 18, /*!< VDD 2.9-3.0 */
    SDIO_OcrVdd31_32Flag = 19, /*!< VDD 3.0-3.1 */
    SDIO_OcrVdd32_33Flag = 20, /*!< VDD 3.1-3.2 */
    SDIO_OcrVdd33_34Flag = 21, /*!< VDD 3.2-3.3 */
    SDIO_OcrVdd34_35Flag = 22, /*!< VDD 3.3-3.4 */
    SDIO_OcrVdd35_36Flag = 23, /*!< VDD 3.4-3.5 */
};
/*! @brief sdio ocr voltage window mask */
#define SDIO_OCR_VOLTAGE_WINDOW_MASK (0xFFFFU << 8U)

/*! @brief sdio ocr reigster IO NUMBER mask  */
#define SDIO_OCR_IO_NUM_MASK (7U << SDIO_OcrIONumber)

/*! @brief sdio capability flag */
enum _sdio_capability_flag
{
    SDIO_CCCRSupportDirectCmdDuringDataTrans = (1U << 0U),  /*!< support direct cmd during data transfer */
    SDIO_CCCRSupportMultiBlock               = (1U << 1U),  /*!< support multi block mode */
    SDIO_CCCRSupportReadWait                 = (1U << 2U),  /*!< support read wait */
    SDIO_CCCRSupportSuspendResume            = (1U << 3U),  /*!< support suspend resume */
    SDIO_CCCRSupportIntDuring4BitDataTrans   = (1U << 4U),  /*!< support interrupt during 4-bit data transfer */
    SDIO_CCCRSupportLowSpeed1Bit             = (1U << 6U),  /*!< support low speed 1bit mode */
    SDIO_CCCRSupportLowSpeed4Bit             = (1U << 7U),  /*!< support low speed 4bit mode */
    SDIO_CCCRSupportMasterPowerControl       = (1U << 8U),  /*!< support master power control */
    SDIO_CCCRSupportHighSpeed                = (1U << 9U),  /*!< support high speed */
    SDIO_CCCRSupportContinuousSPIInt         = (1U << 10U), /*!< support continuous SPI interrupt */
};
...
enum _sdio_fbr_flag
{
    SDIO_FBRSupportCSA            = (1U << 0U), /*!< function support CSA */
    SDIO_FBRSupportPowerSelection = (1U << 1U), /*!< function support power selection */
};

/*! @brief sdio bus width */
typedef enum _sdio_bus_width
{
    SDIO_DataBus1Bit = 0x00U, /*!< 1 bit bus mode */
    SDIO_DataBus4Bit = 0X02U, /*!< 4 bit bus mode*/
    SDIO_DataBus8Bit = 0X03U, /*!< 8 bit bus mode*/
} sdio_bus_width_t;
...
{
    MMC_ClassifiedVoltageHigh = 0U, /*!< High-voltage MMC card */
    MMC_ClassifiedVoltageDual = 1U, /*!< Dual-voltage MMC card */
} mmc_classified_voltage_t;

/*! @brief MMC card classified as density level */
typedef enum _mmc_classified_density
{
    MMC_ClassifiedDensityWithin2GB = 0U, /*!< Density byte is less than or equal 2GB */
    MMC_ClassifiedDensityHigher2GB = 1U, /* Density byte is higher than 2GB */
...
{
    MMC_VoltageWindowNone      = 0U,     /*!< voltage window is not define by user*/
    MMC_VoltageWindow120       = 0x01U,  /*!< Voltage window is 1.20V */
    MMC_VoltageWindow170to195  = 0x02U,  /*!< Voltage window is 1.70V to 1.95V */
    MMC_VoltageWindows270to360 = 0x1FFU, /*!< Voltage window is 2.70V to 3.60V */
...
{
    MMC_CommandSetStandard = 0U, /*!< Standard MMC */
    MMC_CommandSet1        = 1U, /*!< Command set 1 */
    MMC_CommandSet2        = 2U, /*!< Command set 2 */
    MMC_CommandSet3        = 3U, /*!< Command set 3 */
    MMC_CommandSet4        = 4U, /*!< Command set 4 */
} mmc_command_set_t;

/*! @brief boot support(BOOT_INFO in Extended CSD) */
enum _mmc_support_boot_mode
{
    MMC_SupportAlternateBoot = 1U, /*!< support alternative boot mode*/
    MMC_SupportDDRBoot       = 2U, /*!< support DDR boot mode*/
    MMC_SupportHighSpeedBoot = 4U, /*!< support high speed boot mode*/
};
...
typedef enum _mmc_high_speed_timing
{
    ...
    MMC_HighSpeed400Timing  = 3U, /*!< MMC card high speed 400 timing*/
...
{
    MMC_BootPartitionEnableNot        = 0U, /*!< Device not boot enabled (default) */
    MMC_BootPartitionEnablePartition1 = 1U, /*!< Boot partition 1 enabled for boot */
    MMC_BootPartitionEnablePartition2 = 2U, /*!< Boot partition 2 enabled for boot */
    MMC_BootPartitionEnableUserAera   = 7U, /*!< User area enabled for boot */
...
{
    MMC_BootModeSDRWithDefaultTiming   = 0U << 3U, /*!< boot mode single data rate with backward compatiable timings */
    MMC_BootModeSDRWithHighSpeedTiming = 1U << 3U, /*!< boot mode single data rate with high speed timing */
    MMC_BootModeDDRTiming              = 2U << 3U, /*!< boot mode dual date rate */
...
{
    MMC_BootPartitionWPDisable = 0x50U, /*!< boot partition write protection disable */
    MMC_BootPartitionPwrWPToBothPartition =
        0x01U, /*!< power on period write protection apply to both boot partitions */
    MMC_BootPartitionPermWPToBothPartition = 0x04U, /*!< permanent write protection apply to both boot partitions */

    MMC_BootPartitionPwrWPToPartition1 = (1U << 7U) | 1U, /*!< power on period write protection apply to partition1 */
    MMC_BootPartitionPwrWPToPartition2 = (1U << 7U) | 3U, /*!< power on period write protection apply to partition2 */

    MMC_BootPartitionPermWPToPartition1 =
        (1U << 7U) | (1U << 2U), /*!< permanent write protection apply to partition1 */
    MMC_BootPartitionPermWPToPartition2 =
        (1U << 7U) | (3U << 2U), /*!< permanent write protection apply to partition2 */

    MMC_BootPartitionPermWPToPartition1PwrWPToPartition2 =
        (1U << 7U) | (1U << 2U) |
        3U, /*!< permanent write protection apply to partition1, power on period write protection apply to partition2 */
    MMC_BootPartitionPermWPToPartition2PwrWPToPartition1 =
        (1U << 7U) | (3U << 2U) |
...
{
    MMC_BootPartitionNotProtected  = 0U, /*!< boot partition not protected */
    MMC_BootPartitionPwrProtected  = 1U, /*!< boot partition is power on period write protected */
    MMC_BootPartitionPermProtected = 2U, /*!< boot partition is permanently protected */
};
...
typedef enum _mmc_access_partition
{
    ...
    MMC_AccessRPMB                     = 3U, /*!< Replay protected mem block */
    MMC_AccessGeneralPurposePartition1 = 4U, /*!< access to general purpose partition 1 */
    MMC_AccessGeneralPurposePartition2 = 5U, /*!< access to general purpose partition 2 */
    MMC_AccessGeneralPurposePartition3 = 6U, /*!< access to general purpose partition 3 */
    MMC_AccessGeneralPurposePartition4 = 7U, /*!< access to general purpose partition 4 */
...
{
    MMC_ExtendedCsdAccessModeCommandSet = 0U, /*!< Command set related setting */
    MMC_ExtendedCsdAccessModeSetBits    = 1U, /*!< Set bits in specific byte in Extended CSD  */
    MMC_ExtendedCsdAccessModeClearBits  = 2U, /*!< Clear bits in specific byte in Extended CSD */
    MMC_ExtendedCsdAccessModeWriteBits  = 3U, /*!< Write a value to specific byte in Extended CSD */
...
{
    MMC_ExtCsdExtPartitionSupport       = (1 << 0U), /*!< partitioning support[160] */
    MMC_ExtCsdEnhancePartitionSupport   = (1 << 1U), /*!< partitioning support[160] */
    MMC_ExtCsdPartitioningSupport       = (1 << 2U), /*!< partitioning support[160] */
    MMC_ExtCsdPrgCIDCSDInDDRModeSupport = (1 << 3U), /*!< CMD26 and CMD27 are support dual data rate [130]*/
    MMC_ExtCsdBKOpsSupport              = (1 << 4U), /*!< background operation feature support [502]*/
    MMC_ExtCsdDataTagSupport            = (1 << 5U), /*!< data tag support[499]*/
    MMC_ExtCsdModeOperationCodeSupport  = (1 << 6U), /*!< mode operation code support[493]*/
} mmc_extended_csd_flags_t;

/*! @brief MMC card boot mode */
enum _mmc_boot_mode
{
    MMC_BootModeNormal      = 0U, /*!< Normal boot */
    MMC_BootModeAlternative = 1U, /*!< Alternative boot */
};
